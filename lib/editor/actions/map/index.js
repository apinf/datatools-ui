  ...
  return function (dispatch: dispatchFn, getState: getStateFn) {
    ...
    reader.onload = e => {
      ...
      if(reader.result) {
        ...
        stopsData = temp.map(val => val.split(','))
      }
      const tempArray = [];
      ...
      if(stopsData && stopsData.length) {
        ...
        console.log(stopsArrayObj,' :: stopsData ',stopsData, ' :: feedSource ',feedSource)
